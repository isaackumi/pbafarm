      ...
      cell: (row) => {
        const getStatusStyles = () => {
          switch (row.status) {
            ...
            case 'harvested':
              return 'bg-foam-deep text-lagoon-800'
            case 'fallow':
              return 'bg-foam text-gray-800'
            case 'empty':
    ...
    <div className="min-h-screen bg-foam">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="page-card p-4">
            <div className="text-sm font-medium text-muted">Ready for Harvest</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="page-card p-6">
            <h3 className="text-lg font-medium text-chart-ink mb-4">Cage Status Distribution</h3>
            <div className="h-64">
          ...
          {/* Harvest Readiness */}
          <div className="page-card p-6">
            <h3 className="text-lg font-medium text-chart-ink mb-4">Harvest Readiness</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <RechartsPieChart>
                  <Pie
        ...
        <div className="mb-6 page-card p-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-chart-ink bg-white border border-input-border rounded-md hover:bg-foam-deep/40"
              >
          ...
          {showFilters && (
            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-chart-ink">DOC Range</label>
              ...
              <div>
                <label className="block text-sm font-medium text-chart-ink">Size Range (m³)</label>
                <div className="flex gap-2">
                  <input
                    type="number"
                    placeholder="Min"
              ...
              <div>
                <label className="block text-sm font-medium text-chart-ink">Installation Date</label>
                <input
                  type="date"
                  className="w-full px-3 py-2 border border-input-border rounded-md"
                />
